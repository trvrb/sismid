...
This exercise can be completed by running the supplied Python script [`mutation-drift.py`](http://github.com/trvrb/sismid/blob/master/selection/mutation-drift/mutation-drift.py). To run the script with population size of 50, per-site per-gen mutation rate of 0.0001, 100 sites and 500 generations, input:
